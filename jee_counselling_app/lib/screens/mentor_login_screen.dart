...
class _MentorLoginScreenState extends State<MentorLoginScreen> {
  ...
  void _submit() async {
    ...
    // Grab the AuthProvider instead of raw SharedPreferences
    ...
    if (_isLogin) {
      ...
      // Use the proper register method to save them to the global database!
  ...
  Widget build(BuildContext context) {
    // We also want to show the AuthProvider's loading spinner if it is doing work
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                  _isLogin ? 'Welcome back' : 'Join as Mentor',
